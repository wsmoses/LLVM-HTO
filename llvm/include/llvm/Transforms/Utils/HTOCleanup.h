...
#ifndef LLVM_TRANSFORMS_UTILS_HTO_CLEANUP_H
#define LLVM_TRANSFORMS_UTILS_HTO_CLEANUP_H
...
class HTOCleanupPass : public PassInfoMixin<HTOCleanupPass> {
public:
  HTOCleanupPass() = default;
